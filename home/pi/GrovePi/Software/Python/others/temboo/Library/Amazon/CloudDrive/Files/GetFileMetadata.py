...
class GetFileMetadata(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetFileMetadata, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Files/GetFileMetadata')


    def new_input_set(self):
        return GetFileMetadataInputSet()

    def _make_result_set(self, result, path):
        return GetFileMetadataResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetFileMetadataChoreographyExecution(session, exec_id, path)

class GetFileMetadataInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('Fields', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The ID of the file to return metadata for.)
        """
        super(GetFileMetadataInputSet, self)._set_input('ID', value)
    def set_MetaDataURL(self, value):
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('MetaDataURL', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetFileMetadataInputSet, self)._set_input('RefreshToken', value)
    def set_TempLink(self, value):
        """
        ...
        """
        super(GetFileMetadataInputSet, self)._set_input('TempLink', value)

class GetFileMetadataResultSet(ResultSet):
    """
...
class GetFileMetadataChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetFileMetadataResultSet(response, path)
