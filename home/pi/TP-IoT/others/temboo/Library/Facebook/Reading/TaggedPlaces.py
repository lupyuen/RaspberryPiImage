...
class TaggedPlaces(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TaggedPlaces, self).__init__(temboo_session, '/Library/Facebook/Reading/TaggedPlaces')


    def new_input_set(self):
        return TaggedPlacesInputSet()

    def _make_result_set(self, result, path):
        return TaggedPlacesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return TaggedPlacesChoreographyExecution(session, exec_id, path)

class TaggedPlacesInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(TaggedPlacesInputSet, self)._set_input('AccessToken', value)
    def set_After(self, value):
        ...
        """
        super(TaggedPlacesInputSet, self)._set_input('After', value)
    def set_Before(self, value):
        ...
        """
        super(TaggedPlacesInputSet, self)._set_input('Before', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((optional, string) A comma separated list of fields to return (i.e. id,name).)
        """
        super(TaggedPlacesInputSet, self)._set_input('Fields', value)
    def set_Limit(self, value):
        ...
        """
        super(TaggedPlacesInputSet, self)._set_input('Limit', value)
    def set_ProfileID(self, value):
        ...
        """
        super(TaggedPlacesInputSet, self)._set_input('ProfileID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(TaggedPlacesInputSet, self)._set_input('ResponseFormat', value)

class TaggedPlacesResultSet(ResultSet):
    """
...
class TaggedPlacesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return TaggedPlacesResultSet(response, path)
