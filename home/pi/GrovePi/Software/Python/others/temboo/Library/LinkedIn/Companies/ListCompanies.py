...
class ListCompanies(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListCompanies, self).__init__(temboo_session, '/Library/LinkedIn/Companies/ListCompanies')
    ...
    def _make_result_set(self, result, path):
        return ListCompaniesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListCompaniesChoreographyExecution(session, exec_id, path)

class ListCompaniesInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(ListCompaniesInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(ListCompaniesInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(ListCompaniesInputSet, self)._set_input('AccessToken', value)
    def set_Count(self, value):
        """
        Set the value of the Count input for this Choreo. ((optional, integer) The number of results to return in the response.)
        """
        super(ListCompaniesInputSet, self)._set_input('Count', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(ListCompaniesInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(ListCompaniesInputSet, self)._set_input('SecretKey', value)
    def set_Start(self, value):
        ...
        """
        super(ListCompaniesInputSet, self)._set_input('Start', value)

class ListCompaniesResultSet(ResultSet):
    """
...
class ListCompaniesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ListCompaniesResultSet(response, path)
