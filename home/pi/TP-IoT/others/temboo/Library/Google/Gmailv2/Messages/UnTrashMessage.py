...
class UnTrashMessage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UnTrashMessage, self).__init__(temboo_session, '/Library/Google/Gmailv2/Messages/UnTrashMessage')


    def new_input_set(self):
        return UnTrashMessageInputSet()

    def _make_result_set(self, result, path):
        return UnTrashMessageResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return UnTrashMessageChoreographyExecution(session, exec_id, path)

class UnTrashMessageInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(UnTrashMessageInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(UnTrashMessageInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(UnTrashMessageInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(UnTrashMessageInputSet, self)._set_input('Fields', value)
    def set_MessageID(self, value):
        ...
        """
        super(UnTrashMessageInputSet, self)._set_input('MessageID', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new Access Token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(UnTrashMessageInputSet, self)._set_input('RefreshToken', value)
    def set_UserID(self, value):
        ...
        """
        super(UnTrashMessageInputSet, self)._set_input('UserID', value)

class UnTrashMessageResultSet(ResultSet):
    """
...
class UnTrashMessageChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return UnTrashMessageResultSet(response, path)
