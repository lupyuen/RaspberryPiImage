...
class FriendLists(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(FriendLists, self).__init__(temboo_session, '/Library/Facebook/Reading/FriendLists')


    def new_input_set(self):
        return FriendListsInputSet()

    def _make_result_set(self, result, path):
        return FriendListsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return FriendListsChoreographyExecution(session, exec_id, path)

class FriendListsInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(FriendListsInputSet, self)._set_input('AccessToken', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((optional, string) A comma separated list of fields to return (i.e. id,name).)
        """
        super(FriendListsInputSet, self)._set_input('Fields', value)
    def set_Limit(self, value):
        ...
        """
        super(FriendListsInputSet, self)._set_input('Limit', value)
    def set_Offset(self, value):
        """
        Set the value of the Offset input for this Choreo. ((optional, integer) Used to page through results. Returns results starting from the specified number.)
        """
        super(FriendListsInputSet, self)._set_input('Offset', value)
    def set_ProfileID(self, value):
        ...
        """
        super(FriendListsInputSet, self)._set_input('ProfileID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(FriendListsInputSet, self)._set_input('ResponseFormat', value)

class FriendListsResultSet(ResultSet):
    """
...
class FriendListsChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return FriendListsResultSet(response, path)
