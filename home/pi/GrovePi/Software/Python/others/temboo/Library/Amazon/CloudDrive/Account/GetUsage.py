...
class GetUsage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetUsage, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Account/GetUsage')


    def new_input_set(self):
        return GetUsageInputSet()

    def _make_result_set(self, result, path):
        return GetUsageResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetUsageChoreographyExecution(session, exec_id, path)

class GetUsageInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetUsageInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetUsageInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(GetUsageInputSet, self)._set_input('ClientSecret', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(GetUsageInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetUsageInputSet, self)._set_input('RefreshToken', value)

class GetUsageResultSet(ResultSet):
    """
...
class GetUsageChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetUsageResultSet(response, path)
