...
class ListMessages(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListMessages, self).__init__(temboo_session, '/Library/Google/Gmailv2/Messages/ListMessages')
...
class ListMessagesInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(ListMessagesInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(ListMessagesInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(ListMessagesInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(ListMessagesInputSet, self)._set_input('Fields', value)
    def set_IncludeSpamTrash(self, value):
        ...
        """
        super(ListMessagesInputSet, self)._set_input('IncludeSpamTrash', value)
    def set_LabelIDs(self, value):
        ...
        """
        super(ListMessagesInputSet, self)._set_input('LabelIDs', value)
    def set_MaxResults(self, value):
        """
        Set the value of the MaxResults input for this Choreo. ((optional, integer) The maximum number of results to return.)
        """
        super(ListMessagesInputSet, self)._set_input('MaxResults', value)
    def set_PageToken(self, value):
        """
        Set the value of the PageToken input for this Choreo. ((optional, string) The "nextPageToken" found in the response which is used to page through results.)
        """
        super(ListMessagesInputSet, self)._set_input('PageToken', value)
    def set_Query(self, value):
        ...
        """
        super(ListMessagesInputSet, self)._set_input('Query', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new Access Token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(ListMessagesInputSet, self)._set_input('RefreshToken', value)
    def set_UserID(self, value):
        ...
        """
        super(ListMessagesInputSet, self)._set_input('UserID', value)
