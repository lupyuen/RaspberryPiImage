...
class Split(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(Split, self).__init__(temboo_session, '/Library/Utilities/Text/Split')
    ...
    def _make_result_set(self, result, path):
        return SplitResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return SplitChoreographyExecution(session, exec_id, path)

class SplitInputSet(InputSet):
    """
    ...
    def set_Delimiter(self, value):
        ...
        """
        super(SplitInputSet, self)._set_input('Delimiter', value)
    def set_Text(self, value):
        """
        Set the value of the Text input for this Choreo. ((required, multiline) The text that should be split into sub-strings.)
        """
        super(SplitInputSet, self)._set_input('Text', value)

class SplitResultSet(ResultSet):
    """
...
class SplitChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return SplitResultSet(response, path)
