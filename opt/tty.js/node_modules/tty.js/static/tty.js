...
function load() {
  ...
  tty.open();
  setTimeout(openWindow, 1000);  ////  Lup Yuen: Open the first window upon loading.
}

var first_window;

function openWindow() {    
  ////  Lup Yuen: Open a new window.
  first_window = new Window;
  //  Switch to dark mode.
  tty.toggleLights();
  //  Maximize the window after a while.
  setTimeout(maximizeWindow, 1000);
}

function maximizeWindow() {
  ////  Lup Yuen: Maximize the window.
