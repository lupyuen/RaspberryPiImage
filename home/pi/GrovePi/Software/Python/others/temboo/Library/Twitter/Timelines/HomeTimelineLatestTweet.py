...
class HomeTimelineLatestTweet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(HomeTimelineLatestTweet, self).__init__(temboo_session, '/Library/Twitter/Timelines/HomeTimelineLatestTweet')


    def new_input_set(self):
        return HomeTimelineLatestTweetInputSet()

    def _make_result_set(self, result, path):
        return HomeTimelineLatestTweetResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return HomeTimelineLatestTweetChoreographyExecution(session, exec_id, path)

class HomeTimelineLatestTweetInputSet(InputSet):
    """
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token provided by Twitter or retrieved during the OAuth process.)
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('AccessToken', value)
    def set_ConsumerKey(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('ConsumerKey', value)
    def set_ConsumerSecret(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('ConsumerSecret', value)
    def set_ContributorDetails(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('ContributorDetails', value)
    def set_ExcludeReplies(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('ExcludeReplies', value)
    def set_IncludeEntities(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('IncludeEntities', value)
    def set_MaxId(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('MaxId', value)
    def set_SinceId(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('SinceId', value)
    def set_TrimUser(self, value):
        ...
        """
        super(HomeTimelineLatestTweetInputSet, self)._set_input('TrimUser', value)

class HomeTimelineLatestTweetResultSet(ResultSet):
    """
...
class HomeTimelineLatestTweetChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return HomeTimelineLatestTweetResultSet(response, path)
