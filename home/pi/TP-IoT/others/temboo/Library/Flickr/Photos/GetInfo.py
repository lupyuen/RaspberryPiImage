...
class GetInfo(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetInfo, self).__init__(temboo_session, '/Library/Flickr/Photos/GetInfo')
...
class GetInfoInputSet(InputSet):
    ...
    def set_APISecret(self, value):
        ...
        """
        super(GetInfoInputSet, self)._set_input('APISecret', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetInfoInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(GetInfoInputSet, self)._set_input('AccessToken', value)
    def set_PhotoID(self, value):
        """
        Set the value of the PhotoID input for this Choreo. ((required, integer) The ID of the photo.)
        """
        super(GetInfoInputSet, self)._set_input('PhotoID', value)
    def set_PhotoSecret(self, value):
        """
        ...
        """
        super(GetInfoInputSet, self)._set_input('PhotoSecret', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml and json. Defaults to json.)
        """
        super(GetInfoInputSet, self)._set_input('ResponseFormat', value)
