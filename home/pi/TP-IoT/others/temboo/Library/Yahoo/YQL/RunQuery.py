...
class RunQuery(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RunQuery, self).__init__(temboo_session, '/Library/Yahoo/YQL/RunQuery')
    ...
    def _make_result_set(self, result, path):
        return RunQueryResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RunQueryChoreographyExecution(session, exec_id, path)

class RunQueryInputSet(InputSet):
    """
    ...
    def set_Diagnostics(self, value):
        ...
        """
        super(RunQueryInputSet, self)._set_input('Diagnostics', value)
    def set_Query(self, value):
        """
        Set the value of the Query input for this Choreo. ((required, string) A YQL (Yahoo! Query Language) statement to execute.)
        """
        super(RunQueryInputSet, self)._set_input('Query', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(RunQueryInputSet, self)._set_input('ResponseFormat', value)

class RunQueryResultSet(ResultSet):
    """
...
class RunQueryChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return RunQueryResultSet(response, path)
