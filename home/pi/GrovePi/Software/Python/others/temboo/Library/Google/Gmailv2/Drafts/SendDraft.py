...
class SendDraft(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SendDraft, self).__init__(temboo_session, '/Library/Google/Gmailv2/Drafts/SendDraft')


    def new_input_set(self):
        return SendDraftInputSet()

    def _make_result_set(self, result, path):
        return SendDraftResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return SendDraftChoreographyExecution(session, exec_id, path)

class SendDraftInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(SendDraftInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(SendDraftInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(SendDraftInputSet, self)._set_input('ClientSecret', value)
    def set_DraftID(self, value):
        """
        Set the value of the DraftID input for this Choreo. ((required, string) The ID of the draft to send.)
        """
        super(SendDraftInputSet, self)._set_input('DraftID', value)
    def set_Fields(self, value):
        ...
        """
        super(SendDraftInputSet, self)._set_input('Fields', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new Access Token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(SendDraftInputSet, self)._set_input('RefreshToken', value)
    def set_UserID(self, value):
        ...
        """
        super(SendDraftInputSet, self)._set_input('UserID', value)

class SendDraftResultSet(ResultSet):
    """
...
class SendDraftChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return SendDraftResultSet(response, path)
