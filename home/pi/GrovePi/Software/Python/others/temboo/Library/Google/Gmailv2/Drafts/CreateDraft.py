...
class CreateDraft(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateDraft, self).__init__(temboo_session, '/Library/Google/Gmailv2/Drafts/CreateDraft')


    def new_input_set(self):
        return CreateDraftInputSet()

    def _make_result_set(self, result, path):
        return CreateDraftResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateDraftChoreographyExecution(session, exec_id, path)

class CreateDraftInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('AccessToken', value)
    def set_AttachmentContentType(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('AttachmentContentType', value)
    def set_AttachmentFileContent(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('AttachmentFileContent', value)
    def set_AttachmentFileName(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('AttachmentFileName', value)
    def set_BCC(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('BCC', value)
    def set_CC(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('CC', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(CreateDraftInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(CreateDraftInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('Fields', value)
    def set_From(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('From', value)
    def set_MessageBodyContentType(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('MessageBodyContentType', value)
    def set_MessageBody(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('MessageBody', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new Access Token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(CreateDraftInputSet, self)._set_input('RefreshToken', value)
    def set_ReplyTo(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('ReplyTo', value)
    def set_Subject(self, value):
        """
        Set the value of the Subject input for this Choreo. ((conditional, string) The email subject.)
        """
        super(CreateDraftInputSet, self)._set_input('Subject', value)
    def set_ThreadID(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('ThreadID', value)
    def set_To(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('To', value)
    def set_UserID(self, value):
        ...
        """
        super(CreateDraftInputSet, self)._set_input('UserID', value)

class CreateDraftResultSet(ResultSet):
    """
...
class CreateDraftChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return CreateDraftResultSet(response, path)
