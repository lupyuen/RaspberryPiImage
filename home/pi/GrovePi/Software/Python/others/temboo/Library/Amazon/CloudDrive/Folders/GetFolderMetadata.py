...
class GetFolderMetadata(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetFolderMetadata, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Folders/GetFolderMetadata')


    def new_input_set(self):
        return GetFolderMetadataInputSet()

    def _make_result_set(self, result, path):
        return GetFolderMetadataResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetFolderMetadataChoreographyExecution(session, exec_id, path)

class GetFolderMetadataInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetFolderMetadataInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetFolderMetadataInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(GetFolderMetadataInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(GetFolderMetadataInputSet, self)._set_input('Fields', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(GetFolderMetadataInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The ID of the folder to return metadata for.)
        """
        super(GetFolderMetadataInputSet, self)._set_input('ID', value)
    def set_MetaDataURL(self, value):
        ...
        """
        super(GetFolderMetadataInputSet, self)._set_input('MetaDataURL', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetFolderMetadataInputSet, self)._set_input('RefreshToken', value)

class GetFolderMetadataResultSet(ResultSet):
    """
...
class GetFolderMetadataChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetFolderMetadataResultSet(response, path)
