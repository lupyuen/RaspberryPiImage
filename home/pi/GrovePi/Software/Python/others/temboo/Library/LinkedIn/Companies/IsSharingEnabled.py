...
class IsSharingEnabled(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(IsSharingEnabled, self).__init__(temboo_session, '/Library/LinkedIn/Companies/IsSharingEnabled')


    def new_input_set(self):
        return IsSharingEnabledInputSet()

    def _make_result_set(self, result, path):
        return IsSharingEnabledResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return IsSharingEnabledChoreographyExecution(session, exec_id, path)

class IsSharingEnabledInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(IsSharingEnabledInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(IsSharingEnabledInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(IsSharingEnabledInputSet, self)._set_input('AccessToken', value)
    def set_CompanyID(self, value):
        ...
        """
        super(IsSharingEnabledInputSet, self)._set_input('CompanyID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(IsSharingEnabledInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(IsSharingEnabledInputSet, self)._set_input('SecretKey', value)

class IsSharingEnabledResultSet(ResultSet):
    """
...
class IsSharingEnabledChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return IsSharingEnabledResultSet(response, path)
