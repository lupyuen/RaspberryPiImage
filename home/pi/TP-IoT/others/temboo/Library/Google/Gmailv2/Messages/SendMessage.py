...
class SendMessage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SendMessage, self).__init__(temboo_session, '/Library/Google/Gmailv2/Messages/SendMessage')
...
class SendMessageInputSet(InputSet):
    ...
    def set_AttachmentContentType(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('AttachmentContentType', value)
    def set_AttachmentFileContent(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('AttachmentFileContent', value)
    def set_AttachmentFileName(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('AttachmentFileName', value)
    def set_BCC(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('BCC', value)
    def set_CC(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('CC', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(SendMessageInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(SendMessageInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('Fields', value)
    ...
    def set_MessageBodyContentType(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('MessageBodyContentType', value)
    ...
    def set_RefreshToken(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('RefreshToken', value)
    def set_ReplyTo(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('ReplyTo', value)
    ...
    def set_ThreadID(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('ThreadID', value)
    ...
    def set_UserID(self, value):
        ...
        """
        super(SendMessageInputSet, self)._set_input('UserID', value)
