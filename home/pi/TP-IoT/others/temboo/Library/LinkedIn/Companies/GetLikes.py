...
class GetLikes(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLikes, self).__init__(temboo_session, '/Library/LinkedIn/Companies/GetLikes')


    def new_input_set(self):
        return GetLikesInputSet()

    def _make_result_set(self, result, path):
        return GetLikesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetLikesChoreographyExecution(session, exec_id, path)

class GetLikesInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetLikesInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetLikesInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(GetLikesInputSet, self)._set_input('AccessToken', value)
    def set_CompanyID(self, value):
        ...
        """
        super(GetLikesInputSet, self)._set_input('CompanyID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(GetLikesInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(GetLikesInputSet, self)._set_input('SecretKey', value)
    def set_UpdateKey(self, value):
        ...
        """
        super(GetLikesInputSet, self)._set_input('UpdateKey', value)

class GetLikesResultSet(ResultSet):
    """
...
class GetLikesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetLikesResultSet(response, path)
