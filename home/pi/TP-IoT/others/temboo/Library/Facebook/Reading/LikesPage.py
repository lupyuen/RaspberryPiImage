...
class LikesPage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LikesPage, self).__init__(temboo_session, '/Library/Facebook/Reading/LikesPage')


    def new_input_set(self):
        return LikesPageInputSet()

    def _make_result_set(self, result, path):
        return LikesPageResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return LikesPageChoreographyExecution(session, exec_id, path)

class LikesPageInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(LikesPageInputSet, self)._set_input('AccessToken', value)
    def set_PageID(self, value):
        ...
        """
        super(LikesPageInputSet, self)._set_input('PageID', value)
    def set_ProfileID(self, value):
        ...
        """
        super(LikesPageInputSet, self)._set_input('ProfileID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(LikesPageInputSet, self)._set_input('ResponseFormat', value)

class LikesPageResultSet(ResultSet):
    """
    ...
    def get_Likes(self):
        ...
        """
        return self._output.get('Likes', None)

class LikesPageChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return LikesPageResultSet(response, path)
