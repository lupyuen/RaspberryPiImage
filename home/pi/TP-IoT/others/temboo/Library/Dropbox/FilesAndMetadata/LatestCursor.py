...
class LatestCursor(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(LatestCursor, self).__init__(temboo_session, '/Library/Dropbox/FilesAndMetadata/LatestCursor')
    ...
    def _make_result_set(self, result, path):
        return LatestCursorResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return LatestCursorChoreographyExecution(session, exec_id, path)

class LatestCursorInputSet(InputSet):
    """
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(LatestCursorInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        """
        super(LatestCursorInputSet, self)._set_input('AccessToken', value)
    def set_AppKey(self, value):
        ...
        """
        super(LatestCursorInputSet, self)._set_input('AppKey', value)
    def set_AppSecret(self, value):
        ...
        """
        super(LatestCursorInputSet, self)._set_input('AppSecret', value)
    def set_IncludeMediaInfo(self, value):
        ...
        """
        super(LatestCursorInputSet, self)._set_input('IncludeMediaInfo', value)
    def set_PathPrefix(self, value):
        ...
        """
        super(LatestCursorInputSet, self)._set_input('PathPrefix', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(LatestCursorInputSet, self)._set_input('ResponseFormat', value)

class LatestCursorResultSet(ResultSet):
    """
...
class LatestCursorChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return LatestCursorResultSet(response, path)
