...
class RemoveChild(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RemoveChild, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Children/RemoveChild')


    def new_input_set(self):
        return RemoveChildInputSet()

    def _make_result_set(self, result, path):
        return RemoveChildResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RemoveChildChoreographyExecution(session, exec_id, path)

class RemoveChildInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('AccessToken', value)
    def set_ChildID(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('ChildID', value)
    def set_ClientID(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('ClientSecret', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_MetaDataURL(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('MetaDataURL', value)
    def set_ParentID(self, value):
        ...
        """
        super(RemoveChildInputSet, self)._set_input('ParentID', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(RemoveChildInputSet, self)._set_input('RefreshToken', value)

class RemoveChildResultSet(ResultSet):
    """
...
class RemoveChildChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return RemoveChildResultSet(response, path)
