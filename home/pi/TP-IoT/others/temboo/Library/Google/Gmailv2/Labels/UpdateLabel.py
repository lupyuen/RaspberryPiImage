...
class UpdateLabel(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(UpdateLabel, self).__init__(temboo_session, '/Library/Google/Gmailv2/Labels/UpdateLabel')


    def new_input_set(self):
        return UpdateLabelInputSet()

    def _make_result_set(self, result, path):
        return UpdateLabelResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return UpdateLabelChoreographyExecution(session, exec_id, path)

class UpdateLabelInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(UpdateLabelInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(UpdateLabelInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(UpdateLabelInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(UpdateLabelInputSet, self)._set_input('Fields', value)
    def set_LabelID(self, value):
        ...
        """
        super(UpdateLabelInputSet, self)._set_input('LabelID', value)
    def set_LabelListVisibility(self, value):
        """
        ...
        """
        super(UpdateLabelInputSet, self)._set_input('LabelListVisibility', value)
    def set_MessageListVisibility(self, value):
        """
        ...
        """
        super(UpdateLabelInputSet, self)._set_input('MessageListVisibility', value)
    def set_Name(self, value):
        """
        Set the value of the Name input for this Choreo. ((required, string) The display name of the label.)
        """
        super(UpdateLabelInputSet, self)._set_input('Name', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new Access Token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(UpdateLabelInputSet, self)._set_input('RefreshToken', value)
    def set_UserID(self, value):
        ...
        """
        super(UpdateLabelInputSet, self)._set_input('UserID', value)

class UpdateLabelResultSet(ResultSet):
    """
...
class UpdateLabelChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return UpdateLabelResultSet(response, path)
