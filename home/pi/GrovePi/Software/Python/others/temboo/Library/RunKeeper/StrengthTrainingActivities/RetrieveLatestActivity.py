...
class RetrieveLatestActivity(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveLatestActivity, self).__init__(temboo_session, '/Library/RunKeeper/StrengthTrainingActivities/RetrieveLatestActivity')
...
class RetrieveLatestActivityResultSet(ResultSet):
    ...
    def get_PrimaryMuscleGroup(self):
        """
        ...
        """
        return self._output.get('PrimaryMuscleGroup', None)
    def get_PrimaryType(self):
        ...
        """
        return self._output.get('PrimaryType', None)
    def get_URI(self):
        """
