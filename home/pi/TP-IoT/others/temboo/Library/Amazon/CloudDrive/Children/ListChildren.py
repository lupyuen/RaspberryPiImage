...
class ListChildren(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListChildren, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Children/ListChildren')


    def new_input_set(self):
        return ListChildrenInputSet()

    def _make_result_set(self, result, path):
        return ListChildrenResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListChildrenChoreographyExecution(session, exec_id, path)

class ListChildrenInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('Fields', value)
    def set_Filters(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('Filters', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_Limit(self, value):
        """
        Set the value of the Limit input for this Choreo. ((optional, string) The maximum number of records to be returned.)
        """
        super(ListChildrenInputSet, self)._set_input('Limit', value)
    def set_MetaDataURL(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('MetaDataURL', value)
    def set_ParentID(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('ParentID', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(ListChildrenInputSet, self)._set_input('RefreshToken', value)
    def set_Sort(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('Sort', value)
    def set_StartToken(self, value):
        ...
        """
        super(ListChildrenInputSet, self)._set_input('StartToken', value)

class ListChildrenResultSet(ResultSet):
    """
...
class ListChildrenChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ListChildrenResultSet(response, path)
