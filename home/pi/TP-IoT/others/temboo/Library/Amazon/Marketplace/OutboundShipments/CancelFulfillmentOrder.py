...
class CancelFulfillmentOrderInputSet(InputSet):
    ...
    def set_MWSAuthToken(self, value):
        ...
        """
        super(CancelFulfillmentOrderInputSet, self)._set_input('MWSAuthToken', value)
    ...
    def set_SellerFulfillmentOrderId(self, value):
        """
        Set the value of the SellerFulfillmentOrderId input for this Choreo. ((required, string) The fulfillment order id that you submitted when creating the order.)
        """
