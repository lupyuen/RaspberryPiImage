...
class GetTimeEstimates(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetTimeEstimates, self).__init__(temboo_session, '/Library/Uber/Estimates/GetTimeEstimates')
    ...
    def _make_result_set(self, result, path):
        return GetTimeEstimatesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetTimeEstimatesChoreographyExecution(session, exec_id, path)

class GetTimeEstimatesInputSet(InputSet):
    """
    ...
    def set_CustomerID(self, value):
        ...
        """
        super(GetTimeEstimatesInputSet, self)._set_input('CustomerID', value)
    def set_ProductID(self, value):
        ...
        """
        super(GetTimeEstimatesInputSet, self)._set_input('ProductID', value)
    def set_ServerToken(self, value):
        ...
        """
        super(GetTimeEstimatesInputSet, self)._set_input('ServerToken', value)
    def set_StartLatitude(self, value):
        ...
        """
        super(GetTimeEstimatesInputSet, self)._set_input('StartLatitude', value)
    def set_StartLongitude(self, value):
        ...
        """
        super(GetTimeEstimatesInputSet, self)._set_input('StartLongitude', value)

class GetTimeEstimatesResultSet(ResultSet):
    """
...
class GetTimeEstimatesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetTimeEstimatesResultSet(response, path)
