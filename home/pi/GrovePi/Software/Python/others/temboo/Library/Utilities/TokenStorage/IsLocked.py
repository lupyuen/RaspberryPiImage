...
class IsLocked(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(IsLocked, self).__init__(temboo_session, '/Library/Utilities/TokenStorage/IsLocked')
    ...
    def _make_result_set(self, result, path):
        return IsLockedResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return IsLockedChoreographyExecution(session, exec_id, path)

class IsLockedInputSet(InputSet):
    """
    ...
    def set_Name(self, value):
        ...
        """
        super(IsLockedInputSet, self)._set_input('Name', value)

class IsLockedResultSet(ResultSet):
    """
...
class IsLockedChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return IsLockedResultSet(response, path)
