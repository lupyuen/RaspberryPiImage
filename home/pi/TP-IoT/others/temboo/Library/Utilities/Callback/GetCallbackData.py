...
class GetCallbackData(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetCallbackData, self).__init__(temboo_session, '/Library/Utilities/Callback/GetCallbackData')
    ...
    def _make_result_set(self, result, path):
        return GetCallbackDataResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetCallbackDataChoreographyExecution(session, exec_id, path)

class GetCallbackDataInputSet(InputSet):
    """
    ...
    def set_CallbackID(self, value):
        ...
        """
        super(GetCallbackDataInputSet, self)._set_input('CallbackID', value)
    ...
    def set_FilterValue(self, value):
        ...
        """
        super(GetCallbackDataInputSet, self)._set_input('FilterValue', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetCallbackDataInputSet, self)._set_input('ResponseFormat', value)

class GetCallbackDataResultSet(ResultSet):
    """
...
class GetCallbackDataChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetCallbackDataResultSet(response, path)
