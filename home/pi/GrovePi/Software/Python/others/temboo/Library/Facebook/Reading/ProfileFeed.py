...
class ProfileFeedInputSet(InputSet):
    ...
    def set_Edge(self, value):
        ...
        """
        super(ProfileFeedInputSet, self)._set_input('Edge', value)
    ...
    def set_Filter(self, value):
        ...
        """
        super(ProfileFeedInputSet, self)._set_input('Filter', value)
    ...
    def set_With(self, value):
        ...
        """
        super(ProfileFeedInputSet, self)._set_input('With', value)
