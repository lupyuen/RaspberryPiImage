...
class GetEndpoint(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetEndpoint, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Account/GetEndpoint')


    def new_input_set(self):
        return GetEndpointInputSet()

    def _make_result_set(self, result, path):
        return GetEndpointResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetEndpointChoreographyExecution(session, exec_id, path)

class GetEndpointInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetEndpointInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetEndpointInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(GetEndpointInputSet, self)._set_input('ClientSecret', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(GetEndpointInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetEndpointInputSet, self)._set_input('RefreshToken', value)

class GetEndpointResultSet(ResultSet):
    """
...
class GetEndpointChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetEndpointResultSet(response, path)
