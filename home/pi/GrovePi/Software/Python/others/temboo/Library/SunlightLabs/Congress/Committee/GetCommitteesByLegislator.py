...
class GetCommitteesByLegislatorInputSet(InputSet):
    ...
    def set_Fields(self, value):
        ...
        """
        super(GetCommitteesByLegislatorInputSet, self)._set_input('Fields', value)
    def set_Page(self, value):
        """
        Set the value of the Page input for this Choreo. ((optional, integer) The page offset.)
        """
        super(GetCommitteesByLegislatorInputSet, self)._set_input('Page', value)
    def set_PerPage(self, value):
        """
        Set the value of the PerPage input for this Choreo. ((optional, integer) The number of results to return per page.)
        """
        super(GetCommitteesByLegislatorInputSet, self)._set_input('PerPage', value)
