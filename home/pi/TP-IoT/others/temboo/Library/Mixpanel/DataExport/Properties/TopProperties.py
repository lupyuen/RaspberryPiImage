...
class TopProperties(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TopProperties, self).__init__(temboo_session, '/Library/Mixpanel/DataExport/Properties/TopProperties')


    def new_input_set(self):
        return TopPropertiesInputSet()

    def _make_result_set(self, result, path):
        return TopPropertiesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return TopPropertiesChoreographyExecution(session, exec_id, path)

class TopPropertiesInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(TopPropertiesInputSet, self)._set_input('APIKey', value)
    def set_APISecret(self, value):
        ...
        """
        super(TopPropertiesInputSet, self)._set_input('APISecret', value)
    def set_EventName(self, value):
        ...
        """
        super(TopPropertiesInputSet, self)._set_input('EventName', value)
    def set_Expire(self, value):
        ...
        """
        super(TopPropertiesInputSet, self)._set_input('Expire', value)
    def set_Limit(self, value):
        ...
        """
        super(TopPropertiesInputSet, self)._set_input('Limit', value)

class TopPropertiesResultSet(ResultSet):
    """
...
class TopPropertiesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return TopPropertiesResultSet(response, path)
