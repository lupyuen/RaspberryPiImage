...
class GetOrCreateDatastore(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetOrCreateDatastore, self).__init__(temboo_session, '/Library/Dropbox/Datastore/GetOrCreateDatastore')


    def new_input_set(self):
        return GetOrCreateDatastoreInputSet()

    def _make_result_set(self, result, path):
        return GetOrCreateDatastoreResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetOrCreateDatastoreChoreographyExecution(session, exec_id, path)

class GetOrCreateDatastoreInputSet(InputSet):
    """
    ...
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetOrCreateDatastoreInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        """
        Set the value of the AccessToken input for this Choreo. ((required, string) The Access Token retrieved during the OAuth process.)
        """
        super(GetOrCreateDatastoreInputSet, self)._set_input('AccessToken', value)
    def set_AppKey(self, value):
        ...
        """
        super(GetOrCreateDatastoreInputSet, self)._set_input('AppKey', value)
    def set_AppSecret(self, value):
        ...
        """
        super(GetOrCreateDatastoreInputSet, self)._set_input('AppSecret', value)
    def set_DatastoreID(self, value):
        """
        ...
        """
        super(GetOrCreateDatastoreInputSet, self)._set_input('DatastoreID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(GetOrCreateDatastoreInputSet, self)._set_input('ResponseFormat', value)

class GetOrCreateDatastoreResultSet(ResultSet):
    """
...
class GetOrCreateDatastoreChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetOrCreateDatastoreResultSet(response, path)
