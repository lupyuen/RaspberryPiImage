...
class GetProfile(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetProfile, self).__init__(temboo_session, '/Library/Uber/User/GetProfile')


    def new_input_set(self):
        return GetProfileInputSet()

    def _make_result_set(self, result, path):
        return GetProfileResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetProfileChoreographyExecution(session, exec_id, path)

class GetProfileInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetProfileInputSet, self)._set_input('AccessToken', value)

class GetProfileResultSet(ResultSet):
    """
...
class GetProfileChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetProfileResultSet(response, path)
