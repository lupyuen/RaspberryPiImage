...
class SetupAccount(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SetupAccount, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Account/SetupAccount')


    def new_input_set(self):
        return SetupAccountInputSet()

    def _make_result_set(self, result, path):
        return SetupAccountResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return SetupAccountChoreographyExecution(session, exec_id, path)

class SetupAccountInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(SetupAccountInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(SetupAccountInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(SetupAccountInputSet, self)._set_input('ClientSecret', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(SetupAccountInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(SetupAccountInputSet, self)._set_input('RefreshToken', value)
    def set_TermsOfUse(self, value):
        """
        Set the value of the TermsOfUse input for this Choreo. ((optional, decimal) The terms of use version. Defaults to 1.0.0.)
        """
        super(SetupAccountInputSet, self)._set_input('TermsOfUse', value)

class SetupAccountResultSet(ResultSet):
    """
...
class SetupAccountChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return SetupAccountResultSet(response, path)
