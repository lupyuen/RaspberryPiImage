...
class AddToTrash(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddToTrash, self).__init__(temboo_session, '/Library/Amazon/CloudDrive/Trash/AddToTrash')


    def new_input_set(self):
        return AddToTrashInputSet()

    def _make_result_set(self, result, path):
        return AddToTrashResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AddToTrashChoreographyExecution(session, exec_id, path)

class AddToTrashInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(AddToTrashInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(AddToTrashInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(AddToTrashInputSet, self)._set_input('ClientSecret', value)
    def set_HandleRequestThrottling(self, value):
        ...
        """
        super(AddToTrashInputSet, self)._set_input('HandleRequestThrottling', value)
    def set_ID(self, value):
        """
        Set the value of the ID input for this Choreo. ((required, string) The ID of the folder to put in the trash.)
        """
        super(AddToTrashInputSet, self)._set_input('ID', value)
    def set_MetaDataURL(self, value):
        ...
        """
        super(AddToTrashInputSet, self)._set_input('MetaDataURL', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(AddToTrashInputSet, self)._set_input('RefreshToken', value)

class AddToTrashResultSet(ResultSet):
    """
...
class AddToTrashChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return AddToTrashResultSet(response, path)
