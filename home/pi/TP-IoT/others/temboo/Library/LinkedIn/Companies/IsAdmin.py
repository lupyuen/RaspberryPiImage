...
class IsAdmin(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(IsAdmin, self).__init__(temboo_session, '/Library/LinkedIn/Companies/IsAdmin')


    def new_input_set(self):
        return IsAdminInputSet()

    def _make_result_set(self, result, path):
        return IsAdminResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return IsAdminChoreographyExecution(session, exec_id, path)

class IsAdminInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(IsAdminInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(IsAdminInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(IsAdminInputSet, self)._set_input('AccessToken', value)
    def set_CompanyID(self, value):
        ...
        """
        super(IsAdminInputSet, self)._set_input('CompanyID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(IsAdminInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(IsAdminInputSet, self)._set_input('SecretKey', value)

class IsAdminResultSet(ResultSet):
    """
...
class IsAdminChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return IsAdminResultSet(response, path)
