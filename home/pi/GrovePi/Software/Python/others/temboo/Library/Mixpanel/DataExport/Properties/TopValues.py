...
class TopValues(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(TopValues, self).__init__(temboo_session, '/Library/Mixpanel/DataExport/Properties/TopValues')


    def new_input_set(self):
        return TopValuesInputSet()

    def _make_result_set(self, result, path):
        return TopValuesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return TopValuesChoreographyExecution(session, exec_id, path)

class TopValuesInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(TopValuesInputSet, self)._set_input('APIKey', value)
    def set_APISecret(self, value):
        ...
        """
        super(TopValuesInputSet, self)._set_input('APISecret', value)
    def set_EventName(self, value):
        ...
        """
        super(TopValuesInputSet, self)._set_input('EventName', value)
    def set_Expire(self, value):
        ...
        """
        super(TopValuesInputSet, self)._set_input('Expire', value)
    def set_Limit(self, value):
        ...
        """
        super(TopValuesInputSet, self)._set_input('Limit', value)
    def set_PropertyName(self, value):
        ...
        """
        super(TopValuesInputSet, self)._set_input('PropertyName', value)

class TopValuesResultSet(ResultSet):
    """
...
class TopValuesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return TopValuesResultSet(response, path)
