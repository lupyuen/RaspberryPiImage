...
class RetrieveLatestEntry(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveLatestEntry, self).__init__(temboo_session, '/Library/RunKeeper/GeneralMeasurements/RetrieveLatestEntry')
...
class RetrieveLatestEntryResultSet(ResultSet):
    ...
    def get_TotalCholesterol(self):
        ...
        """
        return self._output.get('TotalCholesterol', None)
    def get_URI(self):
        """
