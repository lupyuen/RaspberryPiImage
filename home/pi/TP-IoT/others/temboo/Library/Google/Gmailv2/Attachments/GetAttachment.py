...
class GetAttachment(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetAttachment, self).__init__(temboo_session, '/Library/Google/Gmailv2/Attachments/GetAttachment')


    def new_input_set(self):
        return GetAttachmentInputSet()

    def _make_result_set(self, result, path):
        return GetAttachmentResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetAttachmentChoreographyExecution(session, exec_id, path)

class GetAttachmentInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetAttachmentInputSet, self)._set_input('AccessToken', value)
    def set_AttachmentID(self, value):
        ...
        """
        super(GetAttachmentInputSet, self)._set_input('AttachmentID', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetAttachmentInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetAttachmentInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(GetAttachmentInputSet, self)._set_input('Fields', value)
    def set_Format(self, value):
        ...
        """
        super(GetAttachmentInputSet, self)._set_input('Format', value)
    def set_MessageID(self, value):
        ...
        """
        super(GetAttachmentInputSet, self)._set_input('MessageID', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetAttachmentInputSet, self)._set_input('RefreshToken', value)
    def set_UserID(self, value):
        ...
        """
        super(GetAttachmentInputSet, self)._set_input('UserID', value)

class GetAttachmentResultSet(ResultSet):
    """
...
class GetAttachmentChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetAttachmentResultSet(response, path)
