...
class RetrieveLatestEntry(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(RetrieveLatestEntry, self).__init__(temboo_session, '/Library/RunKeeper/Sleep/RetrieveLatestEntry')
...
class RetrieveLatestEntryResultSet(ResultSet):
    ...
    def get_TotalSleep(self):
        ...
        """
        return self._output.get('TotalSleep', None)
    def get_URI(self):
        """
