...
class GetHistoricalFollowers(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetHistoricalFollowers, self).__init__(temboo_session, '/Library/LinkedIn/Companies/GetHistoricalFollowers')
    ...
    def _make_result_set(self, result, path):
        return GetHistoricalFollowersResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetHistoricalFollowersChoreographyExecution(session, exec_id, path)

class GetHistoricalFollowersInputSet(InputSet):
    """
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('APIKey', value)
    def set_AccessTokenSecret(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('AccessTokenSecret', value)
    def set_AccessToken(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('AccessToken', value)
    def set_CompanyID(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('CompanyID', value)
    def set_EndTimestamp(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('EndTimestamp', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: xml (the default) and json.)
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('ResponseFormat', value)
    def set_SecretKey(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('SecretKey', value)
    def set_StartTimestamp(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('StartTimestamp', value)
    def set_TimeGranularity(self, value):
        ...
        """
        super(GetHistoricalFollowersInputSet, self)._set_input('TimeGranularity', value)

class GetHistoricalFollowersResultSet(ResultSet):
    """
...
class GetHistoricalFollowersChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetHistoricalFollowersResultSet(response, path)
