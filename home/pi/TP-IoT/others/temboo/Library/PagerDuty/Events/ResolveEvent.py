...
class ResolveEvent(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ResolveEvent, self).__init__(temboo_session, '/Library/PagerDuty/Events/ResolveEvent')


    def new_input_set(self):
        return ResolveEventInputSet()

    def _make_result_set(self, result, path):
        return ResolveEventResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ResolveEventChoreographyExecution(session, exec_id, path)

class ResolveEventInputSet(InputSet):
    """
    ...
    def set_Description(self, value):
        ...
        """
        super(ResolveEventInputSet, self)._set_input('Description', value)
    def set_Details(self, value):
        ...
        """
        super(ResolveEventInputSet, self)._set_input('Details', value)
    def set_IncidentKey(self, value):
        ...
        """
        super(ResolveEventInputSet, self)._set_input('IncidentKey', value)
    def set_ServiceKey(self, value):
        ...
        """
        super(ResolveEventInputSet, self)._set_input('ServiceKey', value)

class ResolveEventResultSet(ResultSet):
    """
...
class ResolveEventChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ResolveEventResultSet(response, path)
