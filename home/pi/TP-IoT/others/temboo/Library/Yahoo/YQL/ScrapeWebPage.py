...
class ScrapeWebPage(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ScrapeWebPage, self).__init__(temboo_session, '/Library/Yahoo/YQL/ScrapeWebPage')


    def new_input_set(self):
        return ScrapeWebPageInputSet()

    def _make_result_set(self, result, path):
        return ScrapeWebPageResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ScrapeWebPageChoreographyExecution(session, exec_id, path)

class ScrapeWebPageInputSet(InputSet):
    """
    ...
    def set_Diagnostics(self, value):
        ...
        """
        super(ScrapeWebPageInputSet, self)._set_input('Diagnostics', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(ScrapeWebPageInputSet, self)._set_input('ResponseFormat', value)
    def set_URL(self, value):
        """
        Set the value of the URL input for this Choreo. ((required, string) The URL of the web page to scrape.)
        """
        super(ScrapeWebPageInputSet, self)._set_input('URL', value)
    def set_XPATH(self, value):
        ...
        """
        super(ScrapeWebPageInputSet, self)._set_input('XPATH', value)

class ScrapeWebPageResultSet(ResultSet):
    """
...
class ScrapeWebPageChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ScrapeWebPageResultSet(response, path)
